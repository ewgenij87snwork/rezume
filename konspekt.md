...
Нужно оочень медленно, сосредоточенно и вдумчиво читать всё,
что приходится гуглить
________________________________________________
________________________________________________

12.07.2019

Как поставить сраввнение github-сайта в "памяти" с заходом от даты 18.07.2019? Ну например не появилась ли новость о вакансии на таких-то сайтах. Т.е. одной кнопкой выполнялся бы поиск по заданному списку сайтов (ukr.net, yandex.ru, google.com, hh.ua, work.ua -- "нужен верстальщик"). С системой оповещения на телефон + viber (т.е. gsm + internet).нужен верстальщик


________________________________________________

КАК ПОНЯТЬ И РЕШИТЬ ОШИБКУ: 
	- Unesxpected (или "не хватает") ; in "@import '@/sass/_mixins.sass"

	Если возникает из-за этого кода:
	...
	Внутри одной подстраницы (дочерней компоненте). Даже если отключить @import="...mixins"
